...
# Ajouter les thèmes au dataframe
df['theme'] = topics

# Affichage des thèmes trouvés
st.subheader("📚 Thèmes détectés automatiquement")
st.write(df[['texte_complet', 'theme']].head(10))

# Graphique interactif des thèmes
